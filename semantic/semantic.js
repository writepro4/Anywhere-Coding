    ...
    .each(function() {
      ...
      module = {
        ...
        showPlaceholder: function() {
          module.debug('Showing placeholder images');
          module.remove.active();
      ...
      module = {
        ...
        setup: {
          ...
          image: function() {
            ...
            ;
            if(src) {
              module.verbose('Lazy loading images', src);
              settings.once           = true;
            ...
            if(settings.transition) {
              if( $.fn.transition !== undefined) {
                if($module.hasClass(className.visible)) {
                  module.debug('Transition already occurred on this images, skipping animation');
                  return;
                }
...
$.fn.visibility.settings = {
  ...
  // special visibility type (images, fixed)
  type                   : false,

  // z-index to use with visibility 'fixed'
  zIndex                 : '10',

  // images only animation settings
  transition             : 'fade in',
  duration               : 1000,
